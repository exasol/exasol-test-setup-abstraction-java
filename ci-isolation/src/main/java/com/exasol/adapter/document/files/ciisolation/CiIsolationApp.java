...
public class CiIsolationApp {
    public static void main(final String[] args) {
        ...
        new CiUserStack(app, CiUserStack.CiUserStackProps.builder().projectName("etsa")
                .addRequiredPermissions(policyReader.readPolicyFromResources("exasol-permissions.json")).build());
        app.synth();
    }
}
